...
import com.frc6324.template.subsystems.drive.gyro.*;
import com.frc6324.template.subsystems.drive.module.*;
import com.frc6324.template.subsystems.drive.module.Module;
import com.frc6324.template.subsystems.drive.odometry.*;
import com.frc6324.template.util.*;
...
public class SwerveDrive extends SubsystemBase {
  ...
  /**
   * Commands the drivetrain to drive at a specified speed relative to its current position while
   * overriding the calculated feedforwards.
   *
   * @param speeds The speeds to achieve.
   * @param feedforwards Feedforwards to send to each swerve module.
   */
  public void runRobotRelativeWithFeedforwards(

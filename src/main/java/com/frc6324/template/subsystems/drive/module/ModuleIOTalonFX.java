...
import static com.frc6324.template.util.PhoenixUtil.tryUntilOk;
...
public class ModuleIOTalonFX extends ModuleIOTalonBase<TalonFX, CANcoder> {
  ...
  protected final MotionMagicTorqueCurrentFOC steerRequest_TorqueCurrent =
      new MotionMagicTorqueCurrentFOC(0);

  /**
   * Creates a new swerve module implementation with TalonFX drive and steer motors as well as a
   * CANcoder as the azimuth encoder.
   *
   * @param driveOutputType The type of output this module's drive motor should use for closed-loop
   *     control.
   * @param steerOutputType The type of output this module'e steer motor should use for closed-loop
   *     control.
  ...
  public ModuleIOTalonFX(
    ...
    tryUntilOk(
        ...
        "Failed to configure the drive motor of module "
            + currentModuleNumber
            + " (ID "
    ...
    tryUntilOk(
        5,
        () -> driveTalon.setPosition(0, 0.25),
        "Failed to re-zero drive motor of module "
            + currentModuleNumber
            + " (ID "
            + constants.DriveMotorId
            + ")!");
  ...
  /**
   * Gets the control request sent to the drive motor with the given velocity, acceleration and
   * feedforwards applied.
   *
   ...
   * @return The control request to send to the drive motor. May output either TorqueCurrentFOC or
   *     Voltage based on the value of {@link #driveOutputType}
   */
